...
columns = ['ID', 'Name', 'Age', 'Photo', 'Nationality', 'Flag',
...
for offset in range(0, 300):
    ...
    for row in table_body.findAll('tr'):
        ...
        nationality = td[1].findAll('a')[0].find(
            'div').find('img').get('title')
        ...
        player_data = pd.DataFrame([[pid, name, age, picture, nationality,
